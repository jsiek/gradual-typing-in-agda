...
plug-blame→¬respect<: (F-cast .(_ Cast.⇒⟨ _ ⟩ _)) (CR<:-cast-same-ℓ _ (CR<:-blame-diff-ℓ ℓ≢ℓ)) = ℓ≢ℓ refl -- □ ⟨ c ⟩
plug-blame→¬respect<: (F-cast .(_ Cast.⇒⟨ _ ⟩ _)) (CR<:-cast-diff-ℓ _ (CR<:-blame-diff-ℓ ℓ≢ℓ)) = ℓ≢ℓ refl
