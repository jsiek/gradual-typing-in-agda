...
module ParamCastReductionOrig (cs : CastStruct) where
  ...
  plug-not-blame : ∀ {Γ A B} {M : Γ ⊢ A} {F : Frame {Γ} A B} {ℓ}
    → plug M F ≢ blame ℓ
  plug-not-blame {F = ParamCastAuxOrig.F-·₁ _} ()
  plug-not-blame {F = ParamCastAuxOrig.F-·₂ _} ()
  plug-not-blame {F = ParamCastAuxOrig.F-if _ _} ()
  plug-not-blame {F = ParamCastAuxOrig.F-×₁ _} ()
  plug-not-blame {F = ParamCastAuxOrig.F-×₂ _} ()
  plug-not-blame {F = ParamCastAuxOrig.F-fst} ()
  plug-not-blame {F = ParamCastAuxOrig.F-snd} ()
  plug-not-blame {F = ParamCastAuxOrig.F-inl} ()
  plug-not-blame {F = ParamCastAuxOrig.F-inr} ()
  plug-not-blame {F = ParamCastAuxOrig.F-case _ _} ()
  plug-not-blame {F = ParamCastAuxOrig.F-cast _} ()
